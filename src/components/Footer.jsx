...
function Footer() {
  ...
  return (
    <footer className="bg-zinc-950 border-t border-zinc-900 text-zinc-400 mt-0 font-creato antialiased w-full relative">
      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 relative z-10">
        ...
        <div className="flex flex-col justify-start">
          <h3 className="text-white text-[10px] uppercase tracking-[0.3em] font-bold mb-4 border-b border-zinc-900/60 pb-2">
          ...
          <div className="space-y-3.5 text-xs font-light tracking-wide">
            ...
            >
              <Globe className="w-3.5 h-3.5 text-[#D4AF37]/70 group-hover:text-[#D4AF37] transition-colors stroke-[1.5]" />
        ...
        <div className="flex flex-col justify-between space-y-6 md:space-y-0 h-full">
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {expertises.map((item, idx) => (
                <span 
                  key={idx} 
                  className="text-[9px] font-medium tracking-wider px-2.5 py-1 rounded-full bg-zinc-950/40 border border-zinc-900 text-zinc-400 select-none hover:border-[#D4AF37]/40 hover:text-zinc-200 transition-all duration-300"
                >
                  {item}
                </span>
              ))}
          ...
          <div className="flex items-center gap-2.5 text-xs font-light pt-2">
            <MapPin className="w-3.5 h-3.5 text-[#D4AF37]/70 shrink-0 stroke-[1.5]" />
      ...
      <div className="border-t border-zinc-900 bg-zinc-950/50 py-5 relative z-10 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[10px] text-zinc-500 tracking-wider">
          ...
          <div className="flex gap-6 uppercase text-[9px] tracking-widest font-bold">
            <span className="hover:text-[#D4AF37] transition-colors duration-300 cursor-pointer">Mentions Légales</span>
            <span className="hover:text-[#D4AF37] transition-colors duration-300 cursor-pointer">Confidentialité</span>
          </div>
        </div>
      </div>
