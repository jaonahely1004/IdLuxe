      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="grid md:grid-cols-12 gap-16">
          ...
          <div className="md:col-span-5">
            <div className="bg-[#111111] p-12 h-full flex flex-col justify-center">
        ...
        {/* Section Action */}
        <section className="mt-32 p-16 text-center">
          <h3 className="font-serif text-4xl text-[#111111] mb-8">Rejoignez notre réseau d'exception</h3>
          <p className="text-gray-500 mb-12 max-w-lg mx-auto text-lg italic">
